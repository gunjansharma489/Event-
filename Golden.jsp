<%-- 
    Document   : Golden
    Created on : Apr 21, 2018, 4:38:00 PM
    Author     : udit1
--%>
...
<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            <h1><center>Registration Form : Golden Package</center></h1><pre> <form action="Goldencheck"> <h2> 
  ...
  <form action="birthday.html">                                                                          <input type="submit" value="Go Back"> </form> </pre>
         </div>
    </body>
</html>
